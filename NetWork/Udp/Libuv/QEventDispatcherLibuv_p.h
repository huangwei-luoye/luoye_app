#ifndef QEVENTDISPATCHER_LIBUV_P_H
#define QEVENTDISPATCHER_LIBUV_P_H
...
class QEventDispatcherLibuv;

class Q_DECL_HIDDEN QEventDispatcherLibuvPrivate {
public:
    QEventDispatcherLibuvPrivate(QEventDispatcherLibuv* const q);
    ~QEventDispatcherLibuvPrivate(void);
...
private:
    Q_DISABLE_COPY(QEventDispatcherLibuvPrivate)
    Q_DECLARE_PUBLIC(QEventDispatcherLibuv)
    QEventDispatcherLibuv* const q_ptr;
...
#endif // QEVENTDISPATCHER_LIBUV_P_H
