...
void QEventDispatcherLibuvPrivate::registerSocketNotifier(QSocketNotifier* notifier)
{
    ...
    data->data = notifier;
    uv_poll_start(data, what, &QEventDispatcherLibuvPrivate::socket_notifier_callback);

    this->m_notifiers.insert(notifier, data);
}

void QEventDispatcherLibuvPrivate::unregisterSocketNotifier(QSocketNotifier* notifier)
{
...
void QEventDispatcherLibuvPrivate::socket_notifier_callback(uv_poll_t* w, int status, int events)
{
    Q_UNUSED(status)
...
bool QEventDispatcherLibuvPrivate::disableSocketNotifiers(bool disable)
{
...
void QEventDispatcherLibuvPrivate::killSocketNotifiers(void)
{
